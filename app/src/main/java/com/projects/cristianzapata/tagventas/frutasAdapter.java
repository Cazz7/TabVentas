...
public class frutasAdapter extends ArrayAdapter<frutas> {
    ...
    public View getView(int posicion, View convertView, ViewGroup parent){
        ...
        if(row==null){
            ...
            holder.image = (ImageView) row.findViewById(R.id.productoVerduras);
            holder.title = (TextView) row.findViewById(R.id.titleVerduras);
            holder.price = (TextView) row.findViewById(R.id.priceVerduras);
